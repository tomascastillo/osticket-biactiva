...
<li>
    <!-- timeline icon -->
    <i class="fa fa-chevron-<?php echo ($entry->type == 'M') ? 'right' : 'left'; ?> bg-<?php echo ($entry->type == 'M') ? 'red' : 'blue'; ?>"></i>
    <div class="timeline-item">
        <?php if ($entry->flags & ThreadEntry::FLAG_EDITED) { ?>
            <span class="time" title="<?php echo sprintf(__('Edited on %s by %s'), Format::datetime($entry->updated), 'You');
            ?>"><i class="fa fa-clock-o"></i><?php echo __('Edited'); ?></span>
        <?php } ?>
