                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" name="keywords" size="30" value="<?php echo Format::htmlchars($settings['keywords']); ?>">
                                <span class="input-group-btn">
                                    <button type="submit" value="<?php echo __('Search');?>" class="btn btn-flat"><i class="fa fa-search"></i>
                                    </button>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="topi_id" style="width: 100%" name="topic_id" class="nowarn form-control" onchange="javascript: this.form.submit(); ">
                            ...
                            if ($tickets->exists(true)) {
                                foreach ($tickets as $T) {
                                    ...
                                    <tr id="<?php echo $T['ticket_id']; ?>">
                                        ...
                                        <td><?php echo HelperTheme::getStatusBag($status); ?></td>
                                        <td>
